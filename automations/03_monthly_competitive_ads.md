...
```bash
python3 automations/lib/fb_ad_library_api.py full --brand "COMPETITOR_NAME" --limit 50
```
...
```bash
python3 "python scripts/competitive creative tracker/competitive_tracker.py" --platforms google linkedin tiktok x
```
...
```bash
python3 automations/lib/gdocs_api.py create --title "Competitive Ad Intelligence - MONTH YEAR"
python3 automations/lib/gdocs_api.py update --doc-name "Competitive Ad Intelligence - MONTH YEAR" --text "BRIEF_CONTENT" --location start
```
