...
## Reader-Facing Samples

### Newsletter Copy (Editorial)

> GitHub was compromised via an AI triage bot in a supply chain attack affecting 4,000 machines.

> OpenAI released GPT-4o, a multimodal model that can process text, audio, and images at GPT-4 quality but 2x faster and 50% cheaper. The "o" stands for "omni."

> Apple's WWDC keynote was 90% AI. The short version: Siri gets an LLM brain, every first-party app gets generative features, and Apple Intelligence is the umbrella brand.
...
## Advertiser-Facing Samples

### Sales Copy

> Reach over 6 million tech professionals. Copywriting services and campaign performance reports included at no additional cost.
...
## Internal / Strategic Samples

*(Add internal writing samples here — emails, strategy docs, Slack messages that sound like your real voice.)*

---

## How to Add Samples

Paste 1-3 paragraphs of your own writing below. Label the context (newsletter, ad, email, Slack, blog, etc.) so the humanizer knows which voice register to match.

### Your Samples

*(Paste your writing here. The humanizer will learn from it.)*
