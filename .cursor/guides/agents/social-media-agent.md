...
- Canonical Path: `ai system/agents/content/social-media-agent.md`

## Purpose
Social repurposing-first agent that converts existing assets into platform-native posts and calendars.

## System Architecture
```mermaid
flowchart TD
  A[Context and Brief Inputs] --> B[Social Media Agent]
...
## Inputs
Source content or theme, platform, tone and constraints.

## Outputs
Repurposed post sets, threads, captions, hooks, and light calendar plans.
