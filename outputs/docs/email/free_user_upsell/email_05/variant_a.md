...
Without this information, generating the email body and CTA would involve hallucinating product features and pricing, which violates the strict constraint: "Do NOT hallucinate features or prices absent from SOURCE OF TRUTH."

Could you please provide these details so I can accurately draft this email?
...
**Email [#]: 7 - Hard Offer (Incentivized Upgrade)**

**Subject:** [Requires Paid Upgrade Details]

**Preview:** [Requires Paid Upgrade Details]

**Body:**

*(Cannot be generated without details on the paid upgrade, its features, pricing, and the specific incentive to be offered.)*

**CTA:** [Button text] → [Link destination]

**Segment/Conditions:** Free users who have not yet upgraded and are nearing the end of the nurture sequence.

---

**Metrics Plan**
*   **Open Rate:** Benchmark 20-25%
*   **Click-Through Rate (CTR) to upgrade page:** Benchmark 2-5%
*   **Conversion Rate (Free to Paid):** Benchmark 0.5-2%
*   **Unsubscribe Rate:** Keep below 0.2%
*   **Revenue Generated:** Track direct revenue from this email.