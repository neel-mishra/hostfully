...
- **New Pricing Structure (Platon)**:
    - **Free**: Connect Google/Meta, Insight, Chat. (Target: Solo Marketers)
    - **Pro**: Unlimited AI, Custom Audiences, Priority Support. (Target: Growth Teams)
    - **Max**: Team Collab, White-glove, Custom Integrations. (Target: Agencies)
    - **Enterprise**: On-prem, SLA, Dedicated Infrastructure. (Target: Large Orgs)
