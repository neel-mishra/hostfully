...
# Markdown Presentation Skill (Persona Preset)

Create professional, presenter-friendly markdown presentations with timing guidance, expandable details, and clean visual hierarchy. Treat this as a **presentation persona preset** that you apply when turning outputs from canonical agents (product, SEO, CS, etc.) into decks or walkthroughs.
...
**Key Takeaway:** We will cover X, Y, and Z to align on our core objectives.
---

## Slide 2: First Section
*Short subheadline providing context or the main argument for this slide*

Content here...

**Key Takeaway:** The single most important point the audience should remember from this slide.
---

## Slide 3: Second Section
*Short subheadline providing context or the main argument for this slide*
...
Use `---` to create visual "slide" breaks between sections. **Every slide must have a Subheadline (in italics) immediately following the Title, and a Key Takeaway (in bold) at the very bottom:**

```markdown
## Slide 2: Section 1
*Subheadline contextualizing this section*

Content...

**Key Takeaway:** The core message of this slide.
---
