...
Ad formats observed:
- [Search ads, Display ads, YouTube ads, In-Feed Video, Promoted Posts, Sponsored Content, etc.]
...
```
ai system/python scripts/competitive creative tracker/
...
```bash
cd "ai system/python scripts/competitive creative tracker"
