...
export const HypeHorizontal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{flex: 0.55, height: '100%', display: 'flex', alignItems: 'center'}}>
        ...
        >
          <div style={{fontSize: 18, letterSpacing: 2, textTransform: 'uppercase', opacity: 0.8}}>
            {beat?.scene === 'proof' ? 'Proof, not fluff' : 'Signal over noise'}
          </div>
          <div style={{fontSize: 40, fontWeight: 700, lineHeight: 1.1, maxWidth: 700}}>
            {beat?.scene === 'cta'
