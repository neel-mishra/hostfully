...
```bash
python3 "ai system/automations/entrypoints/run_08.py" --dry-run
```

To execute any command in this runbook with Phase 0 protections, route it through the wrapper:

```bash
python3 "ai system/automations/entrypoints/run_08.py" -- python3 "ai system/automations/lib/preflight_automations.py" --automation 8 --strict
```
...
```bash
python3 "ai system/automations/entrypoints/run_08.py" -- python3 "ai system/automations/lib/gsc_api.py" search-analytics --start-date 14_DAYS_AGO --end-date TODAY_DATE --dimensions page --limit 100
python3 "ai system/automations/entrypoints/run_08.py" -- python3 "ai system/automations/lib/gsc_api.py" sitemaps-list
```
...
```bash
python3 "ai system/python scripts/cro and website intelligence agent/cro_hypothesis_agent.py"
```
