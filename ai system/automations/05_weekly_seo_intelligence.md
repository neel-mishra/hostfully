...
```bash
python3 "ai system/automations/entrypoints/run_05.py" --dry-run
```

To execute any command in this runbook with Phase 0 protections, route it through the wrapper:

```bash
python3 "ai system/automations/entrypoints/run_05.py" -- python3 "ai system/automations/lib/preflight_automations.py" --automation 5 --strict
```
...
```bash
python3 "ai system/automations/entrypoints/run_05.py" -- python3 "ai system/automations/lib/gsc_api.py" search-analytics --start-date 90_DAYS_AGO_DATE --end-date TODAY_DATE --dimensions query,page --limit 500
```
...
```bash
python3 "ai system/automations/entrypoints/run_05.py" -- python3 "ai system/automations/lib/ahrefs_api.py" top-pages --target COMPETITOR_DOMAIN --date TODAY_DATE --limit 20
```
